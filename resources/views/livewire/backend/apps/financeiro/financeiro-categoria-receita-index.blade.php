<div>
    <div class="container">
        ...
        <div class="text-center">
            <h1 class="font-weight-bolder text-dark mb-6">Nenhuma <span class="text-info">categoria</span> cadastrada!</h1>
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <span class="svg-icon svg-icon-full">
                        <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/illustrations/data-points.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            id="a26a8f0d-4f9c-4927-88fb-2c6a33da07b1" data-name="Layer 1" width="1167.52"
                            height="754.06" viewBox="0 0 1167.52 754.06">
                            <g opacity="0.2">
                                <path
                                    ...
                                    transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                                <ellipse cx="1022.06" cy="779.24" rx="14.01" ry="10.7"
                                    transform="translate(-161.16 1244.78) rotate(-62.09)" fill="#3f3d56"></ellipse>
                                <ellipse cx="1030.07" cy="764.11" rx="14.01" ry="10.7"
                                    transform="translate(-143.52 1243.81) rotate(-62.09)" fill="#3f3d56"></ellipse>
                                <ellipse cx="1038.09" cy="748.97" rx="14.01" ry="10.7"
                                    transform="translate(-125.88 1242.84) rotate(-62.09)" fill="#3f3d56"></ellipse>
                                <ellipse cx="1046.11" cy="733.84" rx="14.01" ry="10.7"
                                    transform="translate(-108.24 1241.87) rotate(-62.09)" fill="#3f3d56"></ellipse>
                                <path
                                    ...
                                    transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                                <path
                                    ...
                                    transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            </g>
                            <g opacity="0.2">
                                <path
                                ...
                                <ellipse cx="985.03" cy="464.84" rx="22.69" ry="17.33"
                                    transform="translate(183.96 1147.12) rotate(-69.16)" fill="#3f3d56"></ellipse>
                                <ellipse cx="994.89" cy="438.92" rx="22.69" ry="17.33"
                                    transform="translate(214.54 1139.64) rotate(-69.16)" fill="#3f3d56"></ellipse>
                                <ellipse cx="1004.76" cy="413.01" rx="22.69" ry="17.33"
                                    transform="translate(245.11 1132.16) rotate(-69.16)" fill="#3f3d56"></ellipse>
                                <ellipse cx="1014.62" cy="387.09" rx="22.69" ry="17.33"
                                    transform="translate(275.69 1124.68) rotate(-69.16)" fill="#3f3d56"></ellipse>
                                <path
                            ...
                            <g opacity="0.2">
                                ...
                                <ellipse cx="206.83" cy="546.21" rx="20.61" ry="26.98"
                                    transform="translate(-139.85 -8.35) rotate(-13.72)" fill="#3f3d56"></ellipse>
                                <ellipse cx="199.01" cy="514.17" rx="20.61" ry="26.98"
                                    transform="translate(-132.48 -11.12) rotate(-13.72)" fill="#3f3d56"></ellipse>
                                <ellipse cx="191.2" cy="482.14" rx="20.61" ry="26.98"
                                    transform="translate(-125.1 -13.89) rotate(-13.72)" fill="#3f3d56"></ellipse>
                                <ellipse cx="183.38" cy="450.11" rx="20.61" ry="26.98"
                                    transform="translate(-117.73 -16.66) rotate(-13.72)" fill="#3f3d56"></ellipse>
                                <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="url(#ab1c7cfe-44b5-4159-9f4a-9e5eb45dcf3d)">
                            </path>
                            <path
                                d="M1077.25,223.5V784.74A17.26,17.26,0,0,1,1060,802H116.51a17.26,17.26,0,0,1-17.26-17.26V223.5Z"
                                transform="translate(-16.24 -72.97)" fill="#fff"></path>
                            <path d="M228.17,216.69V802H116.51a17.26,17.26,0,0,1-17.26-17.26v-568Z"
                                transform="translate(-16.24 -72.97)" fill="#d7d9e1"></path>
                            <path
                                d="M1077.25,198.56V223.5h-978V198.56a8.56,8.56,0,0,1,8.56-8.56h960.88A8.56,8.56,0,0,1,1077.25,198.56Z"
                                transform="translate(-16.24 -72.97)" fill="#ededf4"></path>
                            <circle cx="98.51" cy="133.52" r="4" fill="#fa5959" opacity="0.8"></circle>
                            <circle cx="109.51" cy="133.52" r="4" fill="#fed253" opacity="0.8"></circle>
                            <circle cx="120.51" cy="133.52" r="4" fill="#8ccf4d" opacity="0.8"></circle>
                            <rect x="371.93" y="199.71" width="94" height="10" fill="#ededf4"></rect>
                            <rect x="371.93" y="228.71" width="528" height="10" fill="#ededf4"></rect>
                            <rect x="371.93" y="257.71" width="528" height="10" fill="#ededf4"></rect>
                            <rect x="371.93" y="286.71" width="528" height="10" fill="#ededf4"></rect>
                            <rect x="371.93" y="315.71" width="528" height="10" fill="#ededf4"></rect>
                            <rect x="95.93" y="199.71" width="94" height="10" fill="#ededf4"></rect>
                            <rect x="95.93" y="228.71" width="94" height="10" fill="#ededf4"></rect>
                            <rect x="95.93" y="257.71" width="94" height="10" fill="#ededf4"></rect>
                            <rect x="95.93" y="286.71" width="94" height="10" fill="#ededf4"></rect>
                            <rect x="95.93" y="315.71" width="94" height="10" fill="#ededf4"></rect>
                            <rect x="640.17" y="170.69" width="4" height="6"
                                transform="translate(799.61 -541.45) rotate(90)"
                                fill="url(#bef5b74f-e0e9-4f25-a252-2de6d30fcb3c)"></rect>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="url(#edd93e19-8656-44cb-97b1-fa57f76832a0)">
                            </path>
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#fbbebe"></path>
                            <path
                                d="M981.25,658.3a26.18,26.18,0,0,0,7-3.53l7.71-4.91a6.72,6.72,0,0,1-5-3.46,17.7,17.7,0,0,1-1.88-6,31.35,31.35,0,0,0-8.86,5.8c-1.07.92-3.32,2.3-3.65,3.73s1.76,2.59,2.57,3.55C979.45,653.83,982.07,658.08,981.25,658.3Z"
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <path
                            ...
                            <g opacity="0.1">
                                <path
                                    ...
                                    transform="translate(-16.24 -72.97)"></path>
                                <path
                            ...
                            <circle cx="874.73" cy="737.28" r="12.43" opacity="0.1"></circle>
                            <circle cx="874.73" cy="737.28" r="7.87" fill="#65617d"></circle>
                            <circle cx="874.73" cy="737.28" r="7.87" opacity="0.1"></circle>
                            <path d="M881.43,790.77l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.7-19.75Z"
                                transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                            <path d="M881.43,790.77l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.7-19.75Z"
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <circle cx="797.23" cy="737.28" r="12.43" fill="#3f3d56"></circle>
                            <circle cx="797.23" cy="737.28" r="12.43" opacity="0.1"></circle>
                            <circle cx="797.23" cy="737.28" r="7.87" fill="#65617d"></circle>
                            <circle cx="797.23" cy="737.28" r="7.87" opacity="0.1"></circle>
                            <path d="M803.94,790.77l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.69-19.75Z"
                                transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                            <path d="M803.94,790.77l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.69-19.75Z"
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                            <polygon points="768.43 719.66 779.62 712.62 900.42 711.58 903.53 719.66 768.43 719.66"
                                fill="#6c63ff"></polygon>
                            <polygon
                            ...
                            <path d="M792.54,795.12l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.69-19.74Z"
                                transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                            <circle cx="882.39" cy="741.63" r="12.43" fill="#3f3d56"></circle>
                            <circle cx="882.39" cy="741.63" r="7.87" fill="#65617d"></circle>
                            <path d="M889.1,795.12l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.69-19.74Z"
                                transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                            <rect x="787.93" y="633.71" width="82" height="82" fill="#ededf4"></rect>
                            <path
                                d="M820.85,742.48h13.9v20.84h-13.9Zm17.37-10.42h13.89v31.26H838.22Zm17.37,17.36h13.89v13.9H855.59Z"
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <rect x="801.93" y="551.71" width="82" height="82" fill="#d7d9e1"></rect>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <rect x="373.93" y="362.71" width="82" height="82" opacity="0.1"></rect>
                            <rect x="371.93" y="360.71" width="82" height="82" fill="#ededf4"></rect>
                            <path
                                d="M420.48,453.85h6.95v41.68h-6.95Zm-10.42,29.52H417v12.16h-6.95Zm20.84-6.95h7v19.11h-7ZM441.32,466h6.95v29.53h-6.95Z"
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <rect x="817.93" y="361.71" width="82" height="82" opacity="0.1"></rect>
                            <rect x="815.93" y="359.71" width="82" height="82" fill="#ededf4"></rect>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <rect x="595.93" y="365.71" width="82" height="82" opacity="0.1"></rect>
                            <rect x="593.93" y="363.71" width="82" height="82" fill="#ededf4"></rect>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <rect x="561.93" y="494.71" width="82" height="82" opacity="0.1"></rect>
                            <rect x="554.93" y="488.71" width="82" height="82" fill="#ededf4"></rect>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="url(#a7aacfe1-33f0-4fa2-a43d-b0dbbe7da94f)">
                            </path>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#65617d"></path>
                            <g opacity="0.05">
                                <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#ffcdd3"></path>
                            <path d="M570.45,624.57l3.69.38.41-.77h0a3.24,3.24,0,0,0-4.07-.67Z"
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <path d="M569.52,626.31l4.86,1.13.11-.72.27-2a3.34,3.34,0,0,0-4.71-.64l-.24,1Z"
                                transform="translate(-16.24 -72.97)" fill="#dce6f2"></path>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <path d="M569.52,626.31l4.86,1.13.11-.72a4.29,4.29,0,0,0-4.68-1.6Z"
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <path d="M647.78,620.77l5.84,2.87.12-1.25a43.62,43.62,0,0,0-5.89-2.61Z"
                                transform="translate(-16.24 -72.97)" opacity="0.1"></path>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#2d293d"></path>
                            <path d="M600,636.75s-13.15,1.74-14.33-.24" transform="translate(-16.24 -72.97)"
                                opacity="0.1"></path>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#a1616a"></path>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
                            <path d="M212.23,692" transform="translate(-16.24 -72.97)" fill="#464353"></path>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <rect x="184.35" y="657.31" width="82" height="82"
                                transform="translate(583.6 1256.35) rotate(167.2)" opacity="0.1"></rect>
                            <rect x="185.86" y="654.91" width="82" height="82"
                                transform="translate(586.04 1251.29) rotate(167.2)" fill="#ededf4"></rect>
                            <path
                                ...
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <path d="M247.89,694.7l-23.65,5.37-5.37-23.64a22.57,22.57,0,1,0,29,18.27Z"
                                transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
                            <path
                    ...
                    <div class="card card-custom wave wave-animate-slow wave-success mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="row">
                                <!--begin::Content-->
                                <div class="col-sm-8">
                                    <h2 class="text-dark mb-4">Crie sua primeira categoria</h2>
                                </div>
                                <!--end::Content-->
                                <!--begin::Button-->
                                <div class="col-sm-4 d-flex align-items-center justify-content-sm-end">
                                    <button wire:click.prevent="create" class="btn font-weight-bolder text-uppercase font-size-lg btn-primary py-3 px-6">
                                        Cadastrar
                                    </button>
                                </div>
                                <!--end::Button-->
                    ...
                    <div class="card card-custom wave wave-animate-slow wave-success mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="row">
                                <!--begin::Content-->
                                <div class="col-sm-8">
                                    <h2 class="text-dark mb-4">Plano de categorias padrão</h2>
                                </div>
                                <!--end::Content-->
                                <!--begin::Button-->
                                <div class="col-sm-4 d-flex align-items-center justify-content-sm-end">
                                    <button wire:click.prevent="importarCategoriasPadrao" class="btn font-weight-bolder text-uppercase font-size-lg btn-primary py-3 px-6">
                                        Importar
                                    </button>
                                </div>
                                <!--end::Button-->
